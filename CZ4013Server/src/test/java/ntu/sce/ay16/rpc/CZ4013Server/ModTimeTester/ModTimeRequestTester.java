package ntu.sce.ay16.rpc.CZ4013Server.ModTimeTester;
...
public class ModTimeRequestTester {
	private Thread serverThread = null;
	private File file = null;
	private String filePath = "test/time.txt";
	private int port = 8885;
	private String contents = "Test Modification Time";
	...
	public void test() throws Exception {
		...
		assertTrue(response.get("content") == null);
		long modTime = (Long)response.get("modification");
		assertTrue(modTime == this.modTime);
	}
